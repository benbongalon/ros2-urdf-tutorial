...
> Note: If you see errors with the message "value is not a valid float", set your locale to 'en_US.UTF-8' as shown in the Installing ROS 2 Guide. ``urdf_parsing`` is known to fail on other locales.
